    ...
    for (const styledObjectKey in styledObject) {
      if (typeof styledObject[styledObjectKey] === 'object') {
        ...
        if (styledObjectKey === 'fontFamily') {
          ...
          this.#fontFamily = (0, _utils.setObjectKeyValue)(this.#fontFamily, [...keyPath, styledObjectKey], styledObject[styledObjectKey]);
  ...
  componentMiddleWare({
    ...
    const OutputComponent = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
      ...
      const {
        variantProps,
        restProps
      } = (0, _styled.getVariantProps)(props, styledConfig);
