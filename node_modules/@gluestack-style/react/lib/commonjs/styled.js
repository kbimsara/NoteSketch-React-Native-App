...
function convertUtiltiyToSXFromProps(componentProps, styledSystemProps, componentStyleConfig, reservedKeys = _styledSystem.reservedKeys, plugins = [], ignoreKeys = new Set(), Component = null, ExtendedConfig = {}) {
  ...
  } = (0, _convertUtilityToSx.convertUtilityPropsToSX)(styledSystemProps, componentStyleConfig === null || componentStyleConfig === void 0 ? void 0 : componentStyleConfig.descendantStyle, componentRestProps, reservedKeys);
...
function verboseStyled(Component, theme, componentStyleConfig = {}, ExtendedConfig, BUILD_TIME_PARAMS, nonVerbosedTheme) {
  ...
  if (BUILD_TIME_PARAMS !== null && BUILD_TIME_PARAMS !== void 0 && BUILD_TIME_PARAMS.orderedResolved) {
    ...
    const {
      styledIds: g,
      verbosedStyleIds
    } = (0, _updateOrderUnResolvedMap.updateOrderUnResolvedMap)(theme, componentHash, declarationType, componentStyleConfig, _styleSheet.GluestackStyleSheet, _reactNative.Platform.OS, isStyledComponent);
    orderedCSSIds = g;
  ...
  const StyledComponent = ({
    ...
    const descendantCSSIds = (0, _react.useMemo)(() => {
      ...
      return ids;
    }, [(0, _stableHash.stableHash)(applyDescendantsStyleCSSIdsAndPropsWithKey), (0, _stableHash.stableHash)(applyDescendantStateStyleCSSIdsAndPropsWithKey.current), (0, _stableHash.stableHash)(applySxDescendantStateStyleCSSIdsAndPropsWithKey.current), ancestorStyleContext]);
